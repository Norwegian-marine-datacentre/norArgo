...
parser.addOption("u", "uncompressed", "uncompressed", "do not compress scripts, only concatenate");
...
exports.main = function main(args) {
    ...
    var group, separator, ordered, concat, outfile,raw,rawOutfile;
    for (var section in sections) {
	    ...
	    if (raw) {
		rawOutfile = outfile.substr(0,outfile.length-3)+options.uncompressed+".js";
		FS.write(rawOutfile,raw);
		print("Wrote "+rawOutfile);
	    }
